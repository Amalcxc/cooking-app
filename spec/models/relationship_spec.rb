...
RSpec.describe Relationship, type: :model do
  it 'makes one user follow another' do
    user1 = User.create(name: 'valid3',username: 'valid@3', email: 'valid@3', password: 'valid3', password_confirmation: 'valid3')
    user2 = User.create(name: 'valid4',username: 'valid@4', email: 'valid@4', password: 'valid4', password_confirmation: 'valid4')
